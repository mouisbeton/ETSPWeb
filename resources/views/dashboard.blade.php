                ...
                <div class="text-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <p class="text-gray-600 mb-4">Manage your projects and track progress</p>
                            <a href="{{ route('projects.index') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
                                View Projects
                            </a>
                        </div>
