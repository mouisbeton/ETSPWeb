...
@section('title', 'Create Task - ' . config('app.name', 'Laravel'))

@section('content')
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create New Task</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-400">For project: <strong>{{ $project->title }}</strong></p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <form method="POST" action="{{ route('tasks.store', $project) }}">
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="{{ route('tasks.index', $project) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            Cancel
                        </a>
